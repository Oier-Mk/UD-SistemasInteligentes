...
state <- problem$state_initial #7,1
is.applicable(state,"Right",problem)
state <- c(7,2)
is.applicable(state,"Right",problem)
state <- c(7,3)
is.applicable(state,"Right",problem)
...
is.applicable(state,"Up",problem)
state <- c(6,4)
is.applicable(state,"Up",problem)
state <- c(5,4)
is.applicable(state,"Left",problem)
state <- c(5,3)
...
is.applicable(state,"Right",problem)
state <- c(3,5)
is.applicable(state,"Down",problem)
state <- c(4,5)
is.applicable(state,"Right",problem)
state <- c(4,6)
